...
FileDialog{
    ...
    id: loadVortexCalibrationFileDialog

    fileMode: FileDialog.OpenFile
    nameFilters: [ 'JSON files (*.json)']

    onAccepted: {
        console.debug(`Open file dialog ${this} accepted. Starting vortex calibration file loading process.`)
        ...
        console.debug(`Vortex calibration file loading process finished.`)

    }

    Component.onCompleted: {
        Globals.References.pages.corrections.sidebar.basic.popups.loadVortexCalibrationFile = loadVortexCalibrationFileDialog
    }
