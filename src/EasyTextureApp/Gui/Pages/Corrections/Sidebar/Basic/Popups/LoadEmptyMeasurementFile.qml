...
FileDialog{
    ...
    id: loadEmptyMeasurementFileDialog

    fileMode: FileDialog.OpenFile
    nameFilters: [ 'JSON files (*.json)']

    onAccepted: {
        console.debug(`Open file dialog ${this} accepted. Starting empty can measurement file loading process.`)
        ...
        console.debug(`Empty can measurement file loading process finished.`)

    }

    Component.onCompleted: {
        Globals.References.pages.corrections.sidebar.basic.popups.loadEmptyMeasurementFile = loadEmptyMeasurementFileDialog
    }
