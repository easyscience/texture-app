    ...
    Row {
        ...
        EaElements.Slider {
            ...
            onValueChanged: {
                ...
                Globals.BackendWrapper.rawDataTwoThetaSliderValueSync = Globals.BackendWrapper.rawDataTwoThetaSliderValue1D
                ...
                if (Globals.BackendWrapper.rawDataResetTwoThetaSlider) {
                    ...
                    if (Globals.BackendWrapper.rawDataRunJavaScriptIsOff1D) {
                        Globals.BackendWrapper.rawDataTwoThetaSliderIndex1D = Globals.BackendWrapper.rawDataGetTwoThetaSliderIndex1D()
                        Globals.BackendWrapper.rawDataTwoThetaSliderIndexSync = Globals.BackendWrapper.rawDataTwoThetaSliderIndex1D
